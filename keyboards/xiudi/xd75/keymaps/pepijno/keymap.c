...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT_ortho_5x15(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, TG(2), TG(5), TG(6), KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_DEL, LT(1, KC_Q), KC_W, KC_E, KC_R, KC_T, KC_HOME, TG(4), KC_PGUP, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS, KC_TAB, KC_A, LT(5, KC_S), LT(4, KC_D), LT(3, KC_F), LT(2, KC_G), KC_END, KC_UP, KC_PGDN, KC_H, KC_J, KC_K, KC_L, LT(2, KC_SCLN), KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LEFT, KC_DOWN, KC_RGHT, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LCTL, KC_LGUI, KC_LEFT, KC_RIGHT, KC_LALT, LCTL_T(KC_SPC), KC_BSPC, KC_DEL, KC_RSFT, KC_ENT, KC_UP, KC_DOWN, QK_BOOTLOADER, RGB_TOG, KC_RCTL),
                                                              ...
                                                              [6] = LAYOUT_ortho_5x15(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_TRNS, KC_TRNS, KC_TRNS, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_DEL, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_HOME, KC_TRNS, KC_PGUP, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_BSLS, KC_TAB, KC_A, KC_R, KC_S, KC_T, KC_D, KC_END, KC_UP, KC_PGDN, KC_H, KC_N, KC_E, KC_I, KC_O, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LEFT, KC_DOWN, KC_RGHT, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_LCTL, KC_LGUI, KC_LEFT, KC_RIGHT, KC_LALT, LCTL_T(KC_SPC), KC_BSPC, KC_DEL, KC_RSFT, KC_ENT, KC_UP, KC_DOWN, QK_BOOTLOADER, RGB_TOG, KC_RCTL)};
