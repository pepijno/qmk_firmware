...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_split_3x5_3(
        KC_Q,            KC_K,         KC_O,            KC_U,           KC_Y,                                        KC_V,           KC_D,         KC_C,         KC_L,         KC_F,
        KC_H,            KC_A,         KC_E,            KC_I,           KC_COMM,                                     KC_G,           KC_T,         KC_R,         KC_N,         KC_S,
        LGUI_T(KC_SLSH), LALT_T(KC_Z), LCTL_T(KC_QUOT), LSFT_T(KC_DOT), KC_X,                                        KC_B,           RSFT_T(KC_P), RCTL_T(KC_M), RALT_T(KC_W), RGUI_T(KC_J),
    ...
    [1] = LAYOUT_split_3x5_3(
        ...
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                  CW_TOGG,  KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,
    ...
    [3] = LAYOUT_split_3x5_3(
        QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   RM_TOGG,  RM_NEXT, RM_HUEU, RM_SATU, RM_VLU,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   RGB_M_TW, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT,
        KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX,                   OU_AUTO,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    ...
    [5] = LAYOUT_split_3x5_3(
        ...
        KC_SCLN, KC_4, KC_5, KC_6,   KC_EQL,                    XXXXXXX, XXXXXXX, XXXXXXX, RM_HUEU, RGB_M_TW,
        KC_GRV,  KC_1, KC_2, KC_3,   KC_BSLS,                   XXXXXXX, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI,
    ...
    [7] = LAYOUT_split_3x5_3(
        ...
        KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE,                   XXXXXXX, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI,
    ...
    [6] = LAYOUT_split_3x5_3(
        ...
        KC_F10, KC_F1, KC_F2, KC_F3,  XXXXXXX,                 XXXXXXX, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI,
    ...
    [8] = LAYOUT_split_3x5_3(
        ...
        KC_Z, KC_X, KC_C, KC_V,   KC_B,                   KC_N,    KC_M,  KC_1, KC_2, KC_3,
                          KC_ESC, LCTL_T(KC_SPC), KC_TAB, KC_ENT, RM_TOGG, TG(8)
    )
};
